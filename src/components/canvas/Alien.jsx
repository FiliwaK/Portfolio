...
export default function Alien() {
  ...
  useFrame(({ clock }) => {
    ...
    // Disparaît quand scroll.offset > 0.22 (section ~1.54)
    group.current.visible = scrollRef.current < 1.54
    ...
    if (antenna.current) {
      antenna.current.material.emissiveIntensity = 0.5 + Math.sin(clock.elapsedTime * 4) * 0.5
    }
  })
